...
public class APCControlSurface extends AbstractControlSurface<APCConfiguration>
{
    ...
    public static final int     APC_BUTTON_CLIP_TRACK      = 0x3A; // mkII device left
    public static final int     APC_BUTTON_DEVICE_ON_OFF   = 0x3B; // mkII device right
    public static final int     APC_BUTTON_DEVICE_LEFT     = 0x3C; // mkII bank left
    public static final int     APC_BUTTON_DEVICE_RIGHT    = 0x3D; // mkII bank right
    public static final int     APC_BUTTON_DETAIL_VIEW     = 0x3E; // mkII dev on/off
    public static final int     APC_BUTTON_REC_QUANT       = 0x3F; // mkII devLock button
    public static final int     APC_BUTTON_MIDI_OVERDUB    = 0x40; // mkII clip/dev view
    public static final int     APC_BUTTON_METRONOME       = 0x41; // mkII detailView
